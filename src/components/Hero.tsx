    ...
    return (
      <div className="relative h-screen bg-hero-pattern bg-no-repeat bg-cover w-full wrapper pt-8">
        <div className="flex gap-2">
          ...
          <div>
            <p className="font-bold text-[38px] md:text-[48px] lg:text-[68px]">
              Hi,I'm <span className="text-[#915eff]">Anoop</span>
            </p>
            <p className="font">
              Experienced Software Engineer with a passion for building
              innovative and user-friendly web applications.
              <br className="sm:block hidden" /> Skilled in full-stack
              development and leveraging modern technologies to create efficient
